...
import "./TheCorner.css";

interface TheCornerProps {}

const TheCorner = ({}: TheCornerProps) => (
  <div className="msrd-NewIdentityTheCorner">
    <Grid>
      <Grid.Item colSpan="4" colSpanNarrow="4" colStartNarrow="2">
        <div className="msrd-NewIdentityTheCorner-label">
      ...
      <Grid.Item colSpan="4" colSpanNarrow="6" rowSpan="2">
        <Image
          alt=""
          height="414"
          src="https://res.cloudinary.com/measuredco/image/upload/f_auto,q_auto/v1740600098/site/corner_pkhjhu.png"
          width="414"
        />
      </Grid.Item>
      <Grid.Item colSpan="4" colSpanNarrow="6" rowSpan="2">
        <div className="msrd-NewIdentityTheCorner-largeTile">
          <div className="msrd-NewIdentityTheCorner-label">
      ...
      <Grid.Item colSpan="6" colSpanNarrow="8" colStart="4" colStartNarrow="2">
        <Space />
        <p className="msrd-NewIdentityTheCorner-description">
