...
import TheCorner from "./components/TheCorner";
...
const NewIdentity = ({ title }: NewIdentityProps) => (
  <div className="msrd-NewIdentity">
    ...
    <Section>
      ...
      <Grid>
        <Grid.Item colSpan="7">
          ...
          <Space />
          <p>
            We kicked off the process with open-ended exploratory work: reading,
            research and prototyping ideas in Figma. We wanted the identity to
            come from us. This work was then distilled into the brief that we
            gave to James.
          </p>
          <Space />
          <p>
          ...
          <p>
            ...
            look at. Once we’d had a chance to digest them, we’d jump on a call
            where James would present the thinking behind them, and we’d give
            feedback. We didn’t need to share written feedback at any stage.
          </p>
          <Space />
          <p>
            We went through three or four rounds, starting with the key concepts
            before arriving at the last details, and ultimately a system that
            felt right.
          </p>
        </Grid.Item>
        ...
        <Grid>
          <Grid.Item align="start" colSpan="4">
            ...
            <p>
              ...
              large type. But James suggested we look at more timeless and
              classic alternatives.
            </p>
          </Grid.Item>
          <Grid.Item colSpan="3" colSpanNarrow="4" colStart="7">
            <div style={{ color: "var(--color-azure-08)" }}>
          ...
          <Grid.Item colSpan="3" colSpanNarrow="6" colStart="10">
            <div className="msrd-NewIdentity-hiddenMobile">
    ...
    <div
      style={{ position: "relative", marginBottom: "-108px", top: "-108px" }}
    >
      <Section>
        <Grid>
          <Grid.Item colSpan="4">
            <div className="msrd-NewIdentity-imageWrapper">
              <Image
                alt=""
                className="msrd-NewIdentity-image"
                height="216"
            ...
            <p style={{ maxWidth: "20em" }}>
              We took James’s advice on styling headlines: Instead of going
              bolder as they get larger, we reduced the weight for a calmer and,
              dare we say, more premium feel.
            </p>
            <Space />
          </Grid.Item>
          <Grid.Item colSpan="4">
        ...
        <Grid>
          <Grid.Item colSpan="7" colSpanNarrow="6">
            <div className="msrd-NewIdentity-imageWrapper msrd-NewIdentity-imageWrapper--large">
              <Image
                alt=""
                className="msrd-NewIdentity-image"
                height="618"
